...
with respect to their inputs as a vector. Because of these, the functionality
...
Fifth, we can also remove reconstruction nodes.
...
The computation cost would be slightly improved as well, since we have single
